;(function(global) {
  ...
  SamGuide.init = function(config) {
    ...
    this.resources = {
      css: `
        div.samguide-container { position: absolute;top: 0px; left: 0px; right: 0px; bottom: 0px; z-index: ${this.config.containerZindex};}
        div.samguide-fog { position: fixed;top: 0px;bottom: 0px;left: 0px;right: 0px;background-color: #000; opacity:${this.config.fogOpacity}; }
  ...
  SamGuide.prototype = {
    ...
    getSlides: function () {
      ...
      .then(result => { self.setData(result) })
    ...
    drawMainBox: function (slide) {
      ...
      [title, content, buttons].forEach(function (e) { box.appendChild(e) })
      return box
    },
    ...
    drawArrowBox: function (slide) {
      ...
      [arrow, buttons].forEach(function (e) { box.appendChild(e) })
      return box
    },
    ...
    setArrowPosition: function(selected, arrow) {
      ...
      arrow.style.top = coordinates.top+ coordinates.height + scrollOffset + this.config.arrowOffset +'px'
